...
func TestParseAttestationConfig(t *testing.T) {
	...
	t.Run("Azure SEV-SNP success", func(t *testing.T) {
		...
		cfg, err := parseAttestationConfig(testMeasurements, testSnpAttestation, attestationVariant)
	...
	t.Run("invalid_measurement_index", func(t *testing.T) {
		...
		_, err := parseAttestationConfig(invalidMeasurements, testSnpAttestation, attestationVariant)
		assert.Error(t, err)
	})
	...
	t.Run("invalid_amd_root_key", func(t *testing.T) {
		...
		_, err := parseAttestationConfig(testMeasurements, invalidAttestation, attestationVariant)
		assert.Error(t, err)
	})
}
