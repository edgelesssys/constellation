...
def go_dependencies():
    ...
    go_repository(
        ...
        replace = "github.com/daniel-weisse/go-sev-guest",
        sum = "h1:IQCKdApn2Us3C516QZnnXj7RlPaVaf87/XPnJKsMnbQ=",
        version = "v0.0.0-20240226152837-6ccbb7b312ea",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Rl5+9rA0kG3vsO1qhncMPRT5eHICihAMQYJkD7u/i4M=",
        version = "v2.6.2",
    )
    go_repository(
