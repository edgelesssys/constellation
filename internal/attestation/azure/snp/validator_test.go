...
func TestInstanceInfoAttestation(t *testing.T) {
	defaultReport := ""
	testCases := map[string]struct {
		reportHex string
		wantErr   bool
	}{
		"report too short": {
			reportHex: defaultReport[:len(defaultReport)-10],
			wantErr:   true,
		},
		"corrupted report": {
	...
	for name, tc := range testCases {
		t.Run(name, func(t *testing.T) {
			...
			rawReport, err := hex.DecodeString(tc.reportHex)
			require.NoError(err)
...
func TestTrustedKeyFromSNP(t *testing.T) {
	...
	defaultVCEK := "-----BEGIN CERTIFICATE----------END CERTIFICATE-----"
	defaultCertChain := "-----BEGIN CERTIFICATE----------END CERTIFICATE----------BEGIN CERTIFICATE----------END CERTIFICATE-----"
	...
	testCases := map[string]struct {
		...
		"invalid vcek": {
			report:             defaultReport,
			runtimeData:        defaultRuntimeData,
			vcek:               "-----BEGIN CERTIFICATE----------END CERTIFICATE-----",
			certChain:          defaultCertChain,
			idkeydigests:       defaultIDKeyDigest,
			enforceIDKeyDigest: idkeydigest.Equal,
			wantErr:            true,
		...
		"malformed ask": {
			...
			runtimeData:        defaultRuntimeData,
			vcek:               defaultVCEK,
			certChain:          "-----BEGIN CERTIFICATE----------END CERTIFICATE----------BEGIN CERTIFICATE----------END CERTIFICATE----------BEGIN CERTIFICATE----------END CERTIFICATE----------BEGIN CERTIFICATE----------END CERTIFICATE-----",
			idkeydigests:       defaultIDKeyDigest,
			enforceIDKeyDigest: idkeydigest.Equal,
			wantErr:            true,
			assertCorrectError: func(err error) {
