...
func DefaultsFor(provider cloudprovider.Provider) M {
	...
	case cloudprovider.AWS:
		return M{
			...
			4: {
				Expected: [32]byte{
					0xb3, 0x51, 0x44, 0x90, 0xae, 0xd3, 0x1d, 0xf8,
					0xf2, 0x19, 0x64, 0x10, 0x79, 0x53, 0x33, 0xe3,
					0x94, 0xfa, 0x22, 0x5a, 0x7a, 0xe6, 0xdb, 0xe3,
			...
			5: {
				Expected: [32]byte{
					0x1f, 0xf1, 0xac, 0xad, 0x3e, 0x81, 0xb9, 0xac,
					0xb3, 0x13, 0x4d, 0xed, 0xe0, 0x2f, 0x72, 0xdb,
					0x42, 0x6f, 0x0a, 0x04, 0xe6, 0x29, 0x54, 0x6d,
			...
			9: {
				Expected: [32]byte{
					0x22, 0xe0, 0xe4, 0x1f, 0x7a, 0xea, 0xf7, 0x6a,
					0x4d, 0x4f, 0xa5, 0x3b, 0x22, 0xb4, 0x1b, 0xf0,
					0x0f, 0x78, 0xda, 0xf6, 0x90, 0xc1, 0x90, 0x2a,
			...
			12: {
				Expected: [32]byte{
					0x32, 0x76, 0xad, 0x0c, 0xec, 0xf5, 0xfd, 0xba,
					0x77, 0xf6, 0xd6, 0x25, 0x3c, 0xaf, 0x9f, 0xd0,
					0x90, 0x03, 0xbe, 0x88, 0xd3, 0x96, 0xfd, 0xf5,
	...
	case cloudprovider.Azure:
		return M{
			...
			4: {
				Expected: [32]byte{
					0xb6, 0xcb, 0xb2, 0x18, 0xdc, 0x45, 0xc3, 0x45,
					0x46, 0xb1, 0xd9, 0x90, 0x7d, 0x9b, 0x35, 0xbf,
					0x9f, 0x4e, 0x36, 0x35, 0xe1, 0xb9, 0x80, 0xdc,
			...
			5: {
				Expected: [32]byte{
					0x64, 0x21, 0x98, 0xf5, 0x87, 0x5c, 0xb7, 0x35,
					0x0c, 0xb5, 0x99, 0x56, 0xa6, 0x1b, 0xde, 0x1b,
					0x95, 0xff, 0x15, 0xbe, 0x5e, 0x92, 0x7f, 0x44,
			...
			12: {
				Expected: [32]byte{
					0x6f, 0xcb, 0x53, 0xd9, 0x95, 0xff, 0xd6, 0x0b,
					0xc1, 0x10, 0x23, 0xc9, 0x1a, 0x0c, 0xe5, 0x23,
					0x46, 0xc0, 0x03, 0xea, 0x28, 0x07, 0xae, 0x2d,
	...
	case cloudprovider.GCP:
		return M{
			...
			4: {
				Expected: [32]byte{
					0x5c, 0x08, 0x21, 0x69, 0x2b, 0x19, 0x0d, 0x92,
					0xd0, 0xfa, 0xbb, 0xe6, 0xe4, 0xde, 0x8f, 0xbb,
					0x4f, 0xae, 0xdf, 0xd0, 0x57, 0xf9, 0xbb, 0xd3,
			...
			9: {
				Expected: [32]byte{
					0x5f, 0xa5, 0xd5, 0x21, 0xd8, 0xfc, 0xe9, 0xd1,
					0xbb, 0xb0, 0x63, 0x67, 0x4b, 0x3b, 0x5b, 0x63,
					0xbd, 0x5d, 0xee, 0x6f, 0x0f, 0xda, 0xb6, 0x76,
			...
			10: {
				Expected: [32]byte{
					0x7f, 0x96, 0xfb, 0xc5, 0x5e, 0x1d, 0x2a, 0x0d,
					0xe4, 0x6e, 0x5d, 0x44, 0x65, 0x8c, 0x06, 0xef,
					0x10, 0x2d, 0x11, 0x98, 0x70, 0x3e, 0xfa, 0x69,
			...
			12: {
				Expected: [32]byte{
					0xb8, 0x24, 0x89, 0x10, 0xeb, 0xe1, 0x19, 0x1c,
					0x29, 0x46, 0x37, 0x37, 0x57, 0xf8, 0xe4, 0xd6,
					0x5d, 0x88, 0x34, 0xa7, 0x2b, 0xc8, 0x35, 0x69,
	...
	case cloudprovider.QEMU:
		return M{
			0: {
				Expected: [32]byte{
					0x7d, 0x08, 0x99, 0x70, 0x28, 0xf3, 0x4f, 0x6c,
					0xcd, 0xd2, 0xed, 0x9b, 0xd3, 0x18, 0x04, 0xcf,
					0x0b, 0x0c, 0x7f, 0xff, 0x9a, 0x4d, 0x05, 0x29,
			...
			1: {
				Expected: [32]byte{
					0xee, 0x07, 0x10, 0x2d, 0x14, 0x18, 0x51, 0x80,
					0x24, 0x11, 0x08, 0x72, 0xa7, 0x13, 0xa9, 0x82,
					0x4b, 0xc7, 0xf6, 0xae, 0x47, 0xd6, 0x2f, 0xd0,
			...
			2: {
				Expected: [32]byte{
					0x72, 0x00, 0x1a, 0x25, 0x20, 0x1b, 0x26, 0x3b,
					0xc6, 0x0f, 0x86, 0x9a, 0xce, 0x2f, 0x72, 0x8b,
					0x09, 0xdc, 0x4b, 0xe7, 0x8b, 0x9c, 0x80, 0xad,
			...
			4: {
				Expected: [32]byte{
					0x83, 0x5a, 0xe5, 0x47, 0xbf, 0x27, 0x52, 0x5d,
					0x17, 0x3e, 0xdb, 0xec, 0xe7, 0x1e, 0x31, 0xed,
					0xea, 0xde, 0x0b, 0xf8, 0x9d, 0x18, 0xf4, 0x46,
			...
			5: {
				Expected: [32]byte{
					0xc9, 0x39, 0x8a, 0xd4, 0x14, 0x99, 0x7a, 0x41,
					0x35, 0xb1, 0x08, 0xdf, 0xf7, 0xc1, 0x8c, 0x15,
					0x33, 0xd7, 0x03, 0x95, 0x04, 0x5e, 0x93, 0x94,
			...
			7: {
				Expected: [32]byte{
					0xdb, 0xc0, 0xbf, 0x1f, 0xfb, 0xa0, 0x30, 0x7a,
					0xa4, 0xef, 0xec, 0xb3, 0x76, 0x6d, 0x8a, 0x36,
					0x55, 0x95, 0xbc, 0x38, 0x4a, 0x3d, 0xcb, 0x87,
			...
			10: {
				Expected: [32]byte{
					0x70, 0x54, 0x86, 0xf7, 0xf5, 0x2b, 0x61, 0xfe,
					0xb5, 0xd2, 0x48, 0x30, 0xad, 0x12, 0xaf, 0xbe,
					0xfb, 0xb2, 0x45, 0xc3, 0xf0, 0xcb, 0x76, 0x74,
			...
			12: {
				Expected: [32]byte{
					0x13, 0xb1, 0x4a, 0xca, 0xf8, 0x67, 0x50, 0xe3,
					0x0d, 0x24, 0x42, 0xcd, 0xbb, 0xcb, 0x0a, 0x9f,
					0x3b, 0x62, 0xfc, 0xc8, 0x8c, 0x05, 0x12, 0xe2,
			...
			14: {
				Expected: [32]byte{
					0xfb, 0xfe, 0x27, 0x0f, 0xee, 0x9d, 0x94, 0xd4,
					0x15, 0x84, 0xab, 0xca, 0x17, 0x94, 0xfb, 0x4a,
					0x42, 0xcf, 0xcf, 0x9a, 0xb4, 0xbe, 0xab, 0xa4,
