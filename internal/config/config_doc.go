...
func init() {
	...
	ConfigDoc.Fields[7].Name = "attestation"
	ConfigDoc.Fields[7].Type = "AttestationConfig"
	ConfigDoc.Fields[7].Note = ""
	ConfigDoc.Fields[7].Description = "Configuration for attestation validation. This configuration provides sensible defaults for the Constellation version it was created for.\nSee the docs for an overview on attestation: https://docs.edgeless.systems/constellation/architecture/attestation"
	ConfigDoc.Fields[7].Comments[encoder.LineComment] = "Configuration for attestation validation. This configuration provides sensible defaults for the Constellation version it was created for.\nSee the docs for an overview on attestation: https://docs.edgeless.systems/constellation/architecture/attestation"
	ConfigDoc.Fields[8].Name = "customEndpoint"
	ConfigDoc.Fields[8].Type = "string"
	ConfigDoc.Fields[8].Note = ""
	ConfigDoc.Fields[8].Description = "Optional custom endpoint (DNS name) for the Constellation API server.\nThis can be used to point a custom dns name at the Constellation API server\nand is added to the Subject Alternative Name (SAN) field of the TLS certificate used by the API server.\nA fallback to DNS name is always available."
	ConfigDoc.Fields[8].Comments[encoder.LineComment] = "Optional custom endpoint (DNS name) for the Constellation API server."
