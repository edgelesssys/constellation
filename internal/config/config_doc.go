...
func init() {
	...
	AzureConfigDoc.Fields[5].Name = "resourceGroup"
	AzureConfigDoc.Fields[5].Type = "string"
	AzureConfigDoc.Fields[5].Note = ""
	AzureConfigDoc.Fields[5].Description = "Resource group to use."
	AzureConfigDoc.Fields[5].Comments[encoder.LineComment] = "Resource group to use."
	AzureConfigDoc.Fields[6].Name = "userAssignedIdentity"
	AzureConfigDoc.Fields[6].Type = "string"
	AzureConfigDoc.Fields[6].Note = ""
	AzureConfigDoc.Fields[6].Description = "Authorize spawned VMs to access Azure API."
	AzureConfigDoc.Fields[6].Comments[encoder.LineComment] = "Authorize spawned VMs to access Azure API."
