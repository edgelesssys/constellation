...
func init() {
	...
	AzureConfigDoc.Fields[5].Description = "DEPRECATED:  Application client ID of the Active Directory app registration."
	AzureConfigDoc.Fields[5].Comments[encoder.LineComment] = "DEPRECATED:  Application client ID of the Active Directory app registration."
