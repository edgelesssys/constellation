...
func init() {
	...
	QEMUConfigDoc.Fields[5].Name = "machine"
	QEMUConfigDoc.Fields[5].Type = "string"
	QEMUConfigDoc.Fields[5].Note = ""
	QEMUConfigDoc.Fields[5].Description = "QEMU Machine type. See 'qemu-system-x86_64 -machine help for details."
	QEMUConfigDoc.Fields[5].Comments[encoder.LineComment] = "QEMU Machine type. See 'qemu-system-x86_64 -machine help for details."
