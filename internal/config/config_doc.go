...
func init() {
	...
	AzureConfigDoc.Fields[6].Description = "Client secret value of the Active Directory app registration credentials. Alternative use CONSTELL_AZURE_CLIENT_SECRET_VALUE environment variable."
	AzureConfigDoc.Fields[6].Comments[encoder.LineComment] = "Client secret value of the Active Directory app registration credentials. Alternative use CONSTELL_AZURE_CLIENT_SECRET_VALUE environment variable."
