...
const (
	...
	LogstashImage = "ghcr.io/edgelesssys/constellation/logstash-debugd:fix-debugd-logcoll" // renovate:container
	// FilebeatImage is the container image of filebeat, used for log collection by debugd.
	FilebeatImage = "ghcr.io/edgelesssys/constellation/filebeat-debugd:fix-debugd-logcoll" // renovate:container
