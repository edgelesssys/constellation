...
const (
	...
	//nolint:revive
	V1_31 ValidK8sVersion = "v1.31.10" // renovate:kubernetes-release
...
var VersionConfigs = map[ValidK8sVersion]KubernetesVersion{
	...
	V1_31: {
		ClusterVersion: "v1.31.10", // renovate:kubernetes-release
		KubernetesComponents: components.Components{
			{
				Url:         "https://github.com/containernetworking/plugins/releases/download/v1.7.1/cni-plugins-linux-amd64-v1.7.1.tgz", // renovate:cni-plugins-release
				Hash:        "sha256:1a28a0506bfe5bcdc981caf1a49eeab7e72da8321f1119b7be85f22621013098",
			...
			{
				Url:         "https://dl.k8s.io/v1.31.10/bin/linux/amd64/kubelet", // renovate:kubernetes-release
				Hash:        "sha256:4e5e2bce4e80575a253654877f0156393d79647a36afb784da27f3ddef446456",
				InstallPath: constants.KubeletPath,
				Extract:     false,
			},
			{
				Url:         "https://dl.k8s.io/v1.31.10/bin/linux/amd64/kubeadm", // renovate:kubernetes-release
				Hash:        "sha256:9653845e48754df94842cce1ef76874e7f4c1a32d782dd0c7e6cf12e3a718dde",
				InstallPath: constants.KubeadmPath,
				Extract:     false,
			},
			{
				Url:         "https://dl.k8s.io/v1.31.10/bin/linux/amd64/kubectl", // renovate:kubernetes-release
