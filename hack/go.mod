...
replace (
	...
	k8s.io/dynamic-resource-allocation v0.0.0 => k8s.io/dynamic-resource-allocation v0.26.1
...
require (
	...
	github.com/edgelesssys/go-tdx-qpl v0.0.0-20230222144800-784639a9fda7 // indirect
