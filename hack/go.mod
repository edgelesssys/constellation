...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/cloudfront v1.26.0 // indirect
	...
	github.com/edgelesssys/go-azguestattestation v0.0.0-20230215110546-6dea66b92bbe // indirect
