...
func runUpgradePlan(cmd *cobra.Command, args []string) error {
	...
	return upgradePlan(cmd, planner, versionListFetcher, fileHandler, http.DefaultClient, rekor, flags, cliVersion)
}

// upgradePlan plans an upgrade of a Constellation cluster.
func upgradePlan(cmd *cobra.Command, planner upgradePlanner, verListFetcher versionListFetcher,
