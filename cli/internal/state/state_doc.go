...
func init() {
	...
	InfrastructureDoc.Fields[1].Description = "Endpoint the cluster can be reached at. This value needs to be set\nby the user in the case of self-managed infrastructure."
	InfrastructureDoc.Fields[1].Comments[encoder.LineComment] = "Endpoint the cluster can be reached at. This value needs to be set"
	InfrastructureDoc.Fields[2].Name = "initSecret"
	InfrastructureDoc.Fields[2].Type = "[]byte"
	InfrastructureDoc.Fields[2].Note = ""
	InfrastructureDoc.Fields[2].Description = "Secret used to authenticate the bootstrapping node. This value needs to be set\nby the user in the case of self-managed infrastructure."
	InfrastructureDoc.Fields[2].Comments[encoder.LineComment] = "Secret used to authenticate the bootstrapping node. This value needs to be set"
	InfrastructureDoc.Fields[3].Name = "apiServerCertSANs"
	InfrastructureDoc.Fields[3].Type = "[]string"
	InfrastructureDoc.Fields[3].Note = ""
	InfrastructureDoc.Fields[3].Description = "List of Subject Alternative Names (SANs) to add to the Kubernetes API server certificate."
	InfrastructureDoc.Fields[3].Comments[encoder.LineComment] = "List of Subject Alternative Names (SANs) to add to the Kubernetes API server certificate."
